<?php
/*
* Example of a view to show, add, modify, or delete records for family members of a family for an user. 
...
* The header and footer and other HTML are in other views, where this view is loaded in, depending on the route the user took
*/
?>
