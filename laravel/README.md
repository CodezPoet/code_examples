...
This code example is proof of concept. It is not an opinion on whether one should use Laravel as frontend for WordPress. There are pros and cons to that. 
